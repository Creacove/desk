...
const nightBusMissionCheckpoints: MissionCheckpointViewModel[] = [
  {
    ...
    rationale: "Release date is locked. Split sheet is blocking rights clearance. Distributor package cannot be marked done until rights clear.",
    managerRead: "Fix split sheet before clearing this phase.",
  ...
  },
  {
    ...
    rationale: "Spotify pitch is submitted. Creator list, EPK, and content approval are still pending.",
    managerRead: "Prepare campaign assets now. Keep outreach conditional.",
  ...
  },
  {
    ...
    rationale: "Outreach wave is not yet sent.",
    managerRead: "Wait for all campaign assets before sending outreach.",
  ...
  },
  {
    ...
    rationale: "Release-day verification starts when the song is live.",
    managerRead: "Hold until the release is confirmed live on June 12.",
  ...
  },
  {
    ...
    rationale: "Post-release signal review happens after launch on June 14.",
    managerRead: "Wait for the 48-hour signal read before scaling spend.",
            ...
            checkpoints: [
              {
                ...
                status: "Waiting on tasks" as const,
                requiredTaskIds: ["fixture-task-geography"],
                dependsOnCheckpointIds: [],
                unlocks: ["Scoped market test"],
                blockedReason: "Waiting for source-backed geography evidence.",
                dependencyImpact: "The scoped market test stays conditional until the signal is validated.",
                watchedSignals: ["geography", "audience response", "source quality"],
                decisionRule: "Do not spend until the geography signal is source-backed.",
                recommendation: "Verify source-backed geography before spending.",
                rationale: "The initial market signal justified a focused validation checkpoint.",
                managerRead: "Verify source-backed geography before spending.",
                nextAction: "Complete the geography validation task.",
              },
              {
                ...
                status: "Waiting on tasks" as const,
                requiredTaskIds: ["fixture-task-test-boundary"],
                dependsOnCheckpointIds: ["fixture-checkpoint-market-signal"],
                unlocks: [],
                blockedReason: "Waiting for the geography signal to support a bounded test.",
                dependencyImpact: "No additional market work should begin without an approved test boundary.",
                watchedSignals: ["budget", "team capacity", "positioning"],
                decisionRule: "Keep the test within the answered budget and operating capacity.",
                recommendation: "Keep the test inside the answered budget and team capacity.",
                rationale: "A bounded test is needed to decide whether the market signal deserves more work.",
                managerRead: "Keep the test inside the answered budget and team capacity.",
                nextAction: "Define the test boundary.",
              },
            ],
            tasks: [
              {
