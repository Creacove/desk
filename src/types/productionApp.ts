...
export type ProductionMusicItem = {
  ...
  assets: Array<{ assetId?: string; label: string; status: string; group: "Audio" | "Artwork" | "Documents"; action: string; assetType?: string; canUpload?: boolean; canReplace?: boolean }>;
