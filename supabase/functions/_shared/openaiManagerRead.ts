...
export function buildManagerReadInstructions(
  ...
  const base = [
    ...
    "The headline must name the exact requested song or project title from packet.subject.title. The situation line and first Manager Read paragraph must stay anchored to that same title.",
    "Do not return the title alone as the headline. Add a concise, specific management judgment after naming the exact title.",
    "Do not introduce characters from an unrelated writing system. Preserve non-Latin proper nouns only when they appear in the source packet.",
    "Never substitute a comparison track, related record, project focus track, or stronger catalog asset for the requested subject, even when that comparison has better metrics.",
