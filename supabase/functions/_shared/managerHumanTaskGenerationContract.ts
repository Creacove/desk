export const MANAGER_HUMAN_TASK_GENERATION_CONTRACT_VERSION = "manager-human-task-generation-v1";
...
export function buildManagerHumanTaskGenerationContract() {
  return [
    ...
    "Never fabricate specificity to make a Task look complete. Do not invent a location, person, collaborator, budget, availability, deadline, audience fact, external commitment, permission, or access that is not in current context.",
    ...
    "Reuse fresh operating facts, memory, completed work, and approved decisions. Do not ask again for known information and do not recreate accepted work unless changed reality invalidated that exact result.",
