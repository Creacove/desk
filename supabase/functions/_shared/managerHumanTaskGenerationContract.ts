...
export function buildManagerHumanTaskGenerationContract() {
  return [
    ...
    "When the task concerns a particular song or project, prefer semanticUnderstanding scoped to that music asset plus artist-level understanding. Do not let understanding from a different song leak into the task merely because it belongs to the same artist.",
