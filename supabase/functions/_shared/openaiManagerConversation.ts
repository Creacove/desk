...
export function buildManagerConversationInstructions(playbookInstructions = "") {
  return [
    ...
    "When focusedMusicSubject.managerRead exists, continue from the attached current Manager Read as the prior understanding of this song. Do not recite public catalog metrics unless the user asks for them or a specific metric directly supports the decision; answer the userâ€™s actual management request and preserve continuity.",
